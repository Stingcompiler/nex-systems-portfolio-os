...
const nextConfig = {
  ...
  experimental: {
    ...
    // الأنماط تُدرَج في الصفحة بدل ثلاثة ملفات منفصلة. حجمها مجتمعة
    // نحو 11 كيلوبايت مضغوطة، لكنها كانت ثلاث رحلات حاجبة للعرض —
    // والرحلة نفسها لا حجمها هي ما يكلّف على شبكات الجوال.
    inlineCss: true,
  },
