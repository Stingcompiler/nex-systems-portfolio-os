  ...
  return (
    ...
    >
      ...
      <form
        ...
        className={cn(
          "mt-4 grid gap-3",
          compact && "md:grid-cols-[1fr_1fr_auto] md:items-end",
        )}
        noValidate
      >
        <div>
      ...
      {compact ? null : (
        <p className="mt-4 text-xs text-muted">{t("whyTwo")}</p>
      )}
    </div>
  );
}
